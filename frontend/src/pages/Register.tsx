...
import { Eye, EyeOff, User, Shield, Mail, Lock, Briefcase, Siren } from 'lucide-react';
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen-safe px-4 py-8 sm:py-12 safe-bottom">
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-10">
            ...
            >
              Join the future of event safety
            </motion.p>
          </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6 relative z-10">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
                  <motion.button
                    ...
                    className={`p-2.5 sm:p-3 rounded-xl transition-all duration-300 relative overflow-hidden ${
              ...
              >
                <label htmlFor="name" className="block text-sm font-medium text-ai-gray-300 mb-2 tracking-wide">
                  Full Name
                </label>
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-ai-gray-500 w-5 h-5 transition-colors group-focus-within:text-ai-gray-300" />
                  <input
                    id="name"
                    type="text"
                    autoComplete="name"
              ...
              >
                ...
                <div className="mt-2 text-xs text-ai-gray-500 space-y-1">
                  <p className={formData.password.length >= 8 ? 'text-green-400' : ''}>
                    • Minimum 8 characters
                  </p>
                  <p className={/[A-Z]/.test(formData.password) ? 'text-green-400' : ''}>
                    • At least one uppercase letter
                  </p>
                  <p className={/[0-9]/.test(formData.password) ? 'text-green-400' : ''}>
                    • At least one number
                  </p>
                  <p className={/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(formData.password) ? 'text-green-400' : ''}>
              ...
              >
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-ai-gray-300 mb-2 tracking-wide">
                  Confirm Password
                </label>
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-ai-gray-500 w-5 h-5 transition-colors group-focus-within:text-ai-gray-300" />
